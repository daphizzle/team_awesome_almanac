...
root_uri = "http://192.168.1.116:8000/iot360/virtualization-layer/"
...
def get_devices():
    devices_uri = "%sscral/devices" % root_uri
    print(devices_uri)
...
def get_current_value_device(device_id):
    uri = "%sscral/devices/%s" % (root_uri, device_id)
    print(uri)
...
for device_id in device_list:
    get_current_value_device(device_id)
